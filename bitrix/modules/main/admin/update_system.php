...
*/
				...
				if (1 || empty($errorMessage) && ($arUpdateList !== false)
					&& defined("DEMO") && DEMO == "Y"
				...
				<?
				if (1 || $arUpdateList !== false && (isset($_REQUEST["BX_SUPPORT_MODE"]) && ($_REQUEST["BX_SUPPORT_MODE"] == "Y")) && isset($arUpdateList["CLIENT"]) && !isset($arUpdateList["UPDATE_SYSTEM"]))
				{
					?>
